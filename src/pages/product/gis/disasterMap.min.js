        ...
        e._data = o.data || [], r.get(e._jsonUrl + e._nameMap[o.mapType] + ".json").then(function (t) {
          ...
          s.length = 0, l.length = 0, e._data.forEach(function (o) {
            l.push({
              name: o.name,
              itemStyle: {
                normal: {areaColor: e._dataAreaColor[o.degree=='轻度'?'0':o.degree=='中度'?'1':'2'], label: {show: !1}},
